...
- `<module>` 和 `<task>` 按语义决定中英文：稳定技术名词优先英文，如 `parser`；更自然的业务表达可保留中文，如 `题单`、`接口契约对齐`。
...
- `plan/题单/pending-题单补抓修复.md`
- `plan/parser/pending-parser-fallback-refactor.md`
- `plan/cross-module/pending-接口契约与解析联调.md`
